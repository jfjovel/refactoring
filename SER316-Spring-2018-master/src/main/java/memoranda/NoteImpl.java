...
public class NoteImpl implements INote, Comparable {
    ...
    public String getTitle() {
        ...
        if (_el.getAttribute("title") == null) return "";
    ...
    public void setTitle(String s) {
        Attribute ta = _el.getAttribute("title");
        if (_el.getAttribute("title") == null) _el.addAttribute(new Attribute("title", s));
        else 
            ta.setValue(s);
    }
	...
	public String getId() {
		...
		if (_el.getAttribute("refid")==null) return "";
	...
	public void setId(String s) {
		//Attribute id = _el.getAttribute("refid");
		if(_el.getAttribute("refid")==null) _el.addAttribute(new Attribute("refid", s));
	}
    /**
	...
	public int compareTo(Object o) {
		INote note = (INote) o;
		if(getDate().getDate().getTime() > note.getDate().getDate().getTime()) return 1;
		else if(getDate().getDate().getTime() < note.getDate().getDate().getTime()) return -1;
		return 0;
	}
